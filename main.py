...
# Columns for GUI
margin_col2, play_col, replay_col, full_graph_col, margin_col2 = st.columns(
    (8.5, 1, 1, 1, 5))
...
# Fourier Transformation and edits
    ...
    if(st.session_state.full_graph_mode == True):
        fn.view_full_chart(time, signal_data,
    ...
    with replay_col:
        ...
        with right_col:
            ...
            fn.plotSpectrogram(
                signal_data, st.session_state.edited_signal_time_domain, sample_freq, time_range)
